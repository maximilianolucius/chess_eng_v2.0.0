...
//    engine.transposition_table.resize(MAX_TT_SIZE);
    ...
    // Print memory usage before resizing
    std::cout << "Before resizing transposition table:" << std::endl;
    print_memory_usage();

    engine.transposition_table.resize(MAX_TT_SIZE);

    // Print memory usage after resizing
    std::cout << "After resizing transposition table:" << std::endl;
    print_memory_usage();
